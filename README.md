...
Thanks for making this project awesome 😍 — feel free to ⭐ and contribute new tools!
...
- [URL Analyser (GTMetrix)](https://gtmetrix.com)
...
- [Small SEO Tools (Keyword Position)](https://smallseotools.com/keyword-position/)
...
- [YellowPipe Robots.txt Generator](http://www.yellowpipe.com/yis/tools/robots.txt/)
- [SEO Book Robots.txt Generator](http://tools.seobook.com/robots-txt/generator/)

---

## 🗺 Sitemap Generators
- [XML-Sitemaps.com](https://www.xml-sitemaps.com/)
- [Timestamp Sitemap Generator](https://timestampgenerator.com/tools/xml-sitemap-from-list)
...
## 📘 Schema Generators
- [MicroData Schema Guide](https://schema.org/docs/gs.html)
...
- [RankTank SERP Tester](https://www.ranktank.org/mobile-friendly-serp-testing-tool/)

---

## 🖼 Image Compressors
- [TinyPNG](https://tinypng.com/)
- [SVG Compressor (Nano)](https://vecta.io/nano)
- [Squoosh](https://squoosh.app/)
- [ImageCompressor](https://compressor.io)
...
- [Varvy Gzip Test Tool](https://varvy.com/tools/gzip/)
...
## 🔗 Broken Link & Redirect Checkers
- [Site Link Checker](https://www.site24x7.com/link-checker.html)
- [Dead Link Checker](https://www.deadlinkchecker.com/)
- [Brokenlink Checker](https://www.brokenlinkcheck.com/)
...
- [Avoid Browser Caching Errors](https://kinsta.com/blog/leverage-browser-caching/)
- [Avoid Render Blocking CSS](https://technumero.com/defer-parsing-of-javascript/)

---

If you found some great tools 🔧, please add them ⭐.  
Thanks for making this project awesome! 😍
